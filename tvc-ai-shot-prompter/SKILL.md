...
description: TVC AI shot prompter for image and video generation. Use when Codex needs to create structured image prompts, Seedance-style video prompts, negative prompts, visual continuity rules, actor/product consistency, camera movement, lighting, color, duration, ratio, sound cue notes, regeneration instructions, or prompt tables for TVC storyboard shots.
---
